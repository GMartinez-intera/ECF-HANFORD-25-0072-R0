...
First = RectGrid()
First.readSPC("../../../stwd/comm/flow/geo_/P2Rv9.1_SW.spc")
print("read first spc")
Second = RectGrid()
Second.readSPC("spc/P2Rv9.1_BC.spc")
print("read second spc")
rec = hds_file.get_data(totim=25202.00)  # BC Model Start Time
print("rec")
...
#    savePestArray(Z, "strt_layer_" + str(k + 1) + ".ref", Second.NROW, Second.NCOL)
    np.savetxt("TESTstrt_layer_" + str(k+1) + ".ref", Z, fmt="%15.6E", delimiter='')
