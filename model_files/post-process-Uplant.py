...
gridangle = 0.0
modelepsg = 32149
namefile = 'P2Rv8.3_tmr_gv_forecast_basecase.nam'
...
up1_list = ['299-W19-125','299-W19-134','299-W19-113','299-W19-114','299-W19-123','299-W19-137']
mnw2 = mnw2[mnw2['WELLID'].isin(up1_list)]
print(mnw2['WELLID'])
mnw2 = mnw2.drop(columns=['Seepage','elev.'])
ucn_file = flopy.utils.binaryfile.UcnFile(os.path.join(str(optm_dir),"tran","WMA_U-Plant_TMR_mt3dms_U_forecast_opt1.ucn"), precision='double')
