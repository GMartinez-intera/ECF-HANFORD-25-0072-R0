...
cht_list<-read.table("chart_area_list.txt",header=TRUE,sep=',')
...
for (ccht in cht_num) {
  ...
  png(paste(sim_path[sim_indx],"/","area",dat_col[sim_indx[1]],"_",fil_path[sim_indx[1]],"_zon",zon_col[sim_indx[1]],"_axs",axs_len[sim_indx[1]],".png",sep=""),width=3294,height=2580,res=300)
  #Build plot
...
#  y_minor<-c(seq(0.1,1,0.1),seq(1,10,1),seq(10,100,10),seq(100,1000,100),seq(1000,10000,1000),seq(10000,100000,10000),seq(100000,1000000,100000),seq(1.0E+5,1.0E+6,1.0E+5),seq(1.0E+6,1.0E+7,1.0E+6))
  ...
  mtext(text=paste("Plume Area Comparison\n",sep=""),side=3,font=2,cex=1.5,line=1)
  mtext(text=expression(paste("Area Above DWS, m"^"2")),side=2,font=2,cex=1.4,line=3)
  #
