...
names=('sl_a' 'sl_b' 'sl_c' 'sl_d' 'sl_e'
       ...
       's3_a' 's3_b' 's3_c' 's3_d' 's3_e'    
       'io_a' 'io_b' 'io_c' 'io_d' 'io_e'
       'mf_a' 'mf_b' 'mf_c' 'mf_d' 'mf_e'
       'sh_a' 'sh_b' 'sh_c' 'sh_d' 'sh_e')    
stwds=('sl_a' 'sl_b' 'sl_c' 'sl_d' 'sl_e'
       'sl_a' 'sl_b' 'sl_c' 'sl_d' 'sl_e'
       'sl_a' 'sl_b' 'sl_c' 'sl_d' 'sl_e'
       'sl_a' 'sl_b' 'sl_c' 'sl_d' 'sl_e'
       'io_a' 'io_b' 'io_c' 'io_d' 'io_e'
       'mf_a' 'mf_b' 'mf_c' 'mf_d' 'mf_e'
...
nums=('127' '246' '351' '62' '320'
      ...
      '127' '246' '351' '62' '320'
      '127' '246' '351' '62' '320')    
well=('sc01' 'sc01' 'sc01' 'sc01' 'sc01'
      'ctet1' 'ctet1' 'ctet1' 'ctet1' 'ctet1'
      'ctet2' 'ctet2' 'ctet2' 'ctet2' 'ctet2'
      'ctet3' 'ctet3' 'ctet3' 'ctet3' 'ctet3'    
      'io01' 'io01' 'io01' 'io01' 'io01'
      'mf01' 'mf01' 'mf01' 'mf01' 'mf01'
      'sh01' 'sh01' 'sh01' 'sh01' 'sh01')
for i in "${!names[@]}" 
do
cn=${names[$i]}
rl=${nums[$i]}
...
for ((c=1;c<=$nl;c++)) do
  ...
  rm ./sims/$cn/flow/strt_layer_$c.ref
done
# MODFLOW Input Files
