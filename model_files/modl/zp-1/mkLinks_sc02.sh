...
ln -sf ../../../comm/flow/bcnd/P2Wv9.1.chd ./sims/$cn/flow/.
...
ln -sf ../../../comm/flow/bcnd/P2Wv9.1_sc02.mnw2 ./sims/$cn/flow/P2Wv9.1.mnw2
...
ln -sf /data/projects/cpcco/src/pest/gwutils/mod2obs_d.x ./sims/$cn/flow/chdp/.
ln -sf ../../../../../stwd/sims/$cn/flow/mod2tec/P2Rv9.1_SW.spc ./sims/$cn/flow/chdp/P2R.spc
ln -sf ../../../../../stwd/sims/$cn/flow/P2Rv9.1.hds ./sims/$cn/flow/chdp/P2R1.hds
ln -sf ../../../../../stwd/sims/$cn/flmn/P2Rv9.1.hds ./sims/$cn/flow/chdp/P2R2.hds
...
ln -sf ../../../../comm/mod2tec/mod2hyd_hds_ext.in ./sims/$cn/flow/mod2tec/.
ln -sf ../../../../comm/mod2tec/mod2hyd_cnc_zp1.in ./sims/$cn/tran/mod2tec/.
ln -sf ../../../../comm/mod2tec/mod2hyd_cnc_ext.in ./sims/$cn/tran/mod2tec/.
...
ln -sf ../../../../comm/mod2tec/getSimEquiv_2W_ext.pl ./sims/$cn/tran/mod2tec/.
ln -sf ../../../../comm/mod2tec/getSimEquiv_2W_mon.pl ./sims/$cn/tran/mod2tec/.
...
for ((c=1;c<=$nl;c++)) do
  ln -sf ../../../comm/tran/prop/prsity_layer_$c.ref ./sims/$cn/tran/prsity_layer_$c.ref
done
for ((c=1;c<=$nl;c++)) do
...
for ((c=1;c<=$nl;c++)) do
  ln -sf ../../../comm/tran/icnc/sconc1_layer_$c.ref ./sims/$cn/tran/sconc1_layer_$c.ref
done
