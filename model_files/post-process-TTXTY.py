...
namefile = 't-tx-ty_mt3dms_baseline_flopy.nam'
...
ttx_list = ['299-W11-117','299-W11-118','299-W14-35','299-W11-119','299-W14-82','299-W11-50','299-W11-90','299-W14-20','299-W14-73']
mnw2 = mnw2[mnw2['WELLID'].isin(ttx_list)]
print(mnw2['WELLID'])
mnw2 = mnw2.drop(columns=['Seepage','elev.'])
ucn_file = flopy.utils.binaryfile.UcnFile(os.path.join(str(optm_dir),"tran","t-tx-ty_mt3dms_baseline_Tc99.ucn"), precision='double')
...
ttx_list = ['299-W11-117','299-W11-118','299-W14-35','299-W11-119','299-W14-82','299-W11-50','299-W11-90','299-W14-20','299-W14-73']
mas_obs = mas_obs[mas_obs['WELL_NAME'].isin(ttx_list)]
