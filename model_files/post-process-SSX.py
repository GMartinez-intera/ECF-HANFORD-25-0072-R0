...
ssx_list = ['299-W22-90','299-W22-91','299-W22-92','299-W22-130','S-SX-EXT-2']
mnw2 = mnw2[mnw2['WELLID'].isin(ssx_list)]
print(mnw2['WELLID'])
mnw2 = mnw2.drop(columns=['Seepage','elev.'])
ucn_file = flopy.utils.binaryfile.UcnFile(os.path.join(str(optm_dir),"tran","WMA_S-SX_TMR_mt3dms_Tc99_2015Adj_forecast_basecase.ucn"), precision='double')
